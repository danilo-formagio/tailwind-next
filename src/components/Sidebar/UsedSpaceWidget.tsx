  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      <div className="space-y-1">
        ...
        <p className="text-sm/5 font-medium text-violet-500 dark:text-zinc-400">
      ...
      <div className="space-x-3">
        <button
          type="button"
          className="dar:text-violet-300 text-sm font-medium text-violet-500 hover:text-violet-700 dark:hover:text-violet-300"
        >
          Dismiss
        </button>
        <button
